		...
		<div class="row">
			<div class="col-md-4 offset-4">
				<div class="card my-card">
					<div class="card-body">
						<p class="fs-3 text-center text-danger">Edit Technician Details</p>
						...
						Technician technician = docDAO.getTechById(id);//call getDoctorById(id) which return technician of specific id
						%>
						...
						<form action="../updateTech" method="post">
							<div class="mb-3">
								<label class="form-label">Full Name</label> <input
									...
									class="form-control" value="<%=technician.getFullName()%>">

							</div>
							<div class="mb-3">
								<label class="form-label">Date of Birth</label> <input
									name="dateOfBirth" type="date" placeholder="Enter DOB"
									class="form-control" value="<%=technician.getDateOfBirth()%>">
							...
							<div class="mb-3">
								<label class="form-label">Qualification</label> <input
									...
									value="<%=technician.getQualification()%>">
							</div>

							<div class="mb-3">
								<label class="form-label">Email address</label> <input
									name="email" type="email" placeholder="Enter Email"
									class="form-control" value="<%=technician.getEmail()%>">

							</div>
							<div class="mb-3">
								<label class="form-label">Phone</label> <input name="phone"
									type="text" placeholder="Enter mobile number"
									class="form-control" value="<%=technician.getPhone()%>">

							</div>
							<div class="mb-3">
								<label class="form-label">Password</label> <input
									name="password" type="text" placeholder="Enter password"
									class="form-control" value="<%=technician.getPassword()%>">
							</div>
