				...
				<div class="card my-card">
					<div class="card-header text-center text-white my-bg-color">
						...
						<p class="fs-4 text-center text-white mt-2">
							<i class="fa-solid fa-stethoscope"></i> Technician Login
						</p>
					</div>

					<div class="card-body">
						<!-- <p class="fs-4 text-center"><i class="fa-solid fa-stethoscope"></i> Technician Login</p> -->
