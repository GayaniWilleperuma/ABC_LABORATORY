...
<head>
<meta charset="UTF-8">
<title>Comment/Prescription Technician</title>
		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card my-card">
					<div class="card-body">
						<p class="text-center fs-3">Leave a Technicians Result</p>
						...
						<form class="row g-3" action="../updateStatus" method="post">
							...
							<div class="col-md-6">
								<label class="form-label">Doctor Name</label> <input name="doctor name"
							...
							<div class="col-md-6">
								<label class="form-label">Test Name</label> <input
									name="diseases" type="text" placeholder="Enter test name"
							...
							<!-- which technician give a comment / technician Id -->
							<input type="hidden" name="techId" value="<%= appointment.getTechnicianId()%>" class="form-control">
